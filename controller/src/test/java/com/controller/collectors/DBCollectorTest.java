...
public class DBCollectorTest {
    ...
    public void mysqlOutputTest() throws IOException, ProcessingException {
        File schemaFile = new File("/vagrant/ottertune/controller/src/main/java/com/controller/json_validation_schema/schema.json");
    ...
    public void mockJsonOutputTest() throws IOException, ProcessingException {
        File schemaFile = new File("/vagrant/ottertune/controller/src/main/java/com/controller/json_validation_schema/schema.json");
        File mockJsonFile1 = new File("/vagrant/ottertune/controller/src/test/java/com/controller/collectors/mock_output/mockJsonOutput1.json");
        File mockJsonFile2 = new File("/vagrant/ottertune/controller/src/test/java/com/controller/collectors/mock_output/mockJsonOutput2.json");
    ...
    public void outputSummaryJsonTest() throws IOException, ProcessingException {
        File schemaFile = new File("/vagrant/ottertune/controller/src/main/java/com/controller/json_validation_schema/summary_schema.json");
